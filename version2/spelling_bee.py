...
# =============================================================================
        ...
        self.corpus_size = len(self.corpus)
        print('''Removed short words. corpus size now {} words
              '''.format(
                self.corpus_size))
    ...
    def _searchCorpus(self):
        ...
        self.corpus_size =  len(self.corpus)
        print('''Removed words that include characters not in the puzzel, {} 
...
class method1(Spelling_Bee):
    ...
    def _corpusSearched(self):
        for word in self.corups[::-1]:
             if not set(list(word)).issubset(self.validLetters):
                 self.corpus.reomve(word)
    ...
    def _searchCorpus(self):
        # =============================================================================
        #         for word in self.corpus:
        #             current = set(list(word))
        #             if not current.issubset(self.validLetters):
        #                 self.corpus.remove(word)
        # =============================================================================
        self.corpus[:] = [word for word in self.corpus 
                   if set(list(word)).issubset(self.validLetters)] 
